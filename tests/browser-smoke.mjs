...
assert.equal(initial.cards, 57, "all sample dishes should render");
assert.equal(initial.clickableCards, 57, "every dish card should expose its item-detail action");
...
assert.equal(offline.cards, 57, "cached dishes should render offline");
